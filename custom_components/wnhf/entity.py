...
from .device import framework_device_info, module_device_info, room_device_info
...
class WNHFPlantEntity(Entity):
    """Base class for room-associated Plant Care entities."""
    ...
    def __init__(
        ...
        self._attr_unique_id = unique_id
        self._attr_suggested_object_id = suggested_object_id
        self._attr_device_info = room_device_info(engine, room_id)
    ...
    @property
    def extra_state_attributes(self) -> dict[str, Any]:
        return {"module": "Plant Care", "version": VERSION}
